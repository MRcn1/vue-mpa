    ...
    ms.classes.Widget = function (el, settings, inherit) {
        ...
        that.show = function (prevAnim, prevFocus) {
            ...
            if (hasButtons) {
                ...
                $.each(buttons, function (i, b) {
                    ...
                    if(b.css=="dwb-n"){
                    	html += '<div' + ' style="width:' + 50 + ' class="dwbw ' + b.css + '"><div tabindex="0" role="button" style="height:40px; font-size: 14px; color:#666; line-height:40px; border:none;" class="dwb dwb' + i + ' dwb-e">' + b.text + '</div></div>';
                    }else if(b.css=="dwb-c"){
                    	html += '<div' + ' style="width:50px; height:30px; border-radius: 5px; position:absolute; top:5px; right:5px;"'+ ' class="dwbw ' + b.css + '"><div tabindex="0" role="button" style="color:#04bf02;border:none;height: 30px;line-height: 30px;border-radius: 3px;"  class="dwb dwb' + i + ' dwb-e">' + b.text + '</div></div>';
                    }else{
                    	html += '<div' + /*(s.btnWidth ? ' style="width:' + 50 + '%"' : '')*/' style="width:50px; height:30px; border-radius: 5px; position:absolute; top:5px; left:5px;"'+ + ' class="dwbw ' + b.css + '"><div tabindex="0" role="button" style="color:#04bf02;height: 30px;line-height: 30px;border-radius: 3px;" class="dwb dwb' + i + ' dwb-e">' + b.text + '</div></div>';
                    }
        ...
        */
        that.init = function (ss) {
            ...
            that.buttons.set = { text: s.setText, css: 'dwb-s', handler: that.cancel };
            that.buttons.cancel = { text: (that.live) ? s.closeText : s.cancelText, css: 'dwb-c', handler: that.select };
